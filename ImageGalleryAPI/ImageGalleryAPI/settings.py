"""
Django settings for ImageGalleryAPI project.
...
SECRET_KEY = 'django-insecure-v%5*j*k#)$4f$rewjbwnz3*=d9zkyrcgsih7ub-6@4)#g3h1o%'
...
MIDDLEWARE = [
    ...
    # to control cache to not save images
...
WSGI_APPLICATION = 'ImageGalleryAPI.wsgi.application'
